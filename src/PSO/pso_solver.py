...
Implements the Particle Swarm Optimization loop used for path planning.
"""
...
from src.PSO.particle import Particule
from src.PSO.path_model import Path
from src.PSO.swarm_model import Swarm
from src.PSO.pso_config import PSOConfig

class PSO:
    """PSO planner orchestrating swarm initialization and optimization."""

    def __init__(self, env: Environment, config: PSOConfig | dict[str, Any] | None = None) -> None:
        """Create a PSO planner for a specific environment."""
